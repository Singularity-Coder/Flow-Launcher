...
public class QuickActionView {
    ...
    private class QuickActionViewLayout extends FrameLayout {
        ...
        public QuickActionViewLayout(Context context, ArrayList<Action> actions, Point centerPoint) {
            ...
            LayoutParams scrimParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            ...
            LayoutParams indicatorParams = new LayoutParams(mIndicatorDrawable.getIntrinsicWidth(), mIndicatorDrawable.getIntrinsicHeight());
