...
val animeFightsList = listOf(
    ...
    YoutubeVideo(title = "Attack on Titan - Eren Rage Mode (Berserk) vs Annie Episode 25", videoId = "w-QxK1I7Va8"),
    YoutubeVideo(title = "Attack on Titan - (EPISODE 24) - Eren Titan Transformation vs Annie Scene", videoId = "GLff3_jPZIM"),
...
val animeMusicList = listOf(
    ...
    YoutubeVideo(title = "Mobile Suit Gundam: Hathaway - EARth", videoId = "vKpOLg3ZJX0"),
    YoutubeVideo(title = "Mobile Suit Gundam: Hathaway - uc0105", videoId = "iITyyr18DJg"),
...
val otherMusicList = listOf(
    ...
    YoutubeVideo(title = "GN Balasubramaniam - Ma Janaki - Khamboji", videoId = "f0Ti5Ty7OYA"), // The faster version. Just as amazing but a bit noisy
    ...
    YoutubeVideo(title = "Once Upon A Time In China Theme (mandarin)", videoId = "OjLSF9KBw4Y"),
...
val otherEpicMomentsList = listOf(
    ...
    YoutubeVideo(title = "Rumble in the Bronx - Jackie Chan training with Wooden Dummy", videoId = "-cWtrGdTjiI"),
    YoutubeVideo(title = "The Enforcer - Father & Son Fight the Bad Guys - Jet Li VS Yu Rongguang", videoId = "De9Auizxxb4"),
    YoutubeVideo(title = "Jackie Chan Who Am I Fight Scene", videoId = "L0FWMk79ELo"),
