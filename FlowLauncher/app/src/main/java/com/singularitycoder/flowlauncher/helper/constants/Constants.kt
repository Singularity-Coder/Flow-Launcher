...
object Broadcast {
    const val VOLUME_RAISED = "${BuildConfig.APPLICATION_ID}.BROADCAST_VOLUME_RAISED"
    const val VOLUME_LOWERED = "${BuildConfig.APPLICATION_ID}.BROADCAST_VOLUME_LOWERED"
    const val DOWNLOAD_COMPLETE = "${BuildConfig.APPLICATION_ID}.BROADCAST_DOWNLOAD_COMPLETE"
    const val NOTIFICATION_LIST = "${BuildConfig.APPLICATION_ID}.BROADCAST_NOTIFICATION_LIST"
}
...
object WorkerTag {
    ...
    const val ENABLE_DISABLE_APPS = "ENABLE_DISABLE_APPS"
}
